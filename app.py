...
I see that you have JSON-formatted YouTube cookies instead of the traditional Netscape format cookies that yt_dlp expects. We need to convert these JSON cookies to the Netscape format that yt_dlp can use.
Let's modify your code to handle this JSON format:
...
def convert_json_cookies_to_netscape(json_cookies, output_path):
    ...
    try:
        ...
        print(f"Error converting cookies: {e}")
        return False
Now, let's modify your download_video function to use this:
pythonCopydef download_video(url, filename="video.mp4"):
    ...
    try:
        ...
        return None, None
Now let's modify the main app code to handle this setup:
